...
def read_halofile(haloproperties_path, massbin_min=1.0e11, massbin_max=1.024e15):
    ...
    indices = (halo_mass > massbin_min) & (halo_mass < massbin_max) & \
             (all_data['sod_halo_count'] > 0)  #& (all_data['sod_halo_cdelta'] > 0)
...
# central–galaxy HOD
Ac       = 0.10           # initial normalisation before density rescaling
log10_Mc = 11.64
sigmaM   = 0.30
gamma    = 5.47           # controls high‑mass tail asymmetry

# satellite HOD
As       = 0.41           # initial normalisation before density rescaling
